    ...
    return BlocConsumer<CalcCubit, CalcState>(
      ...
      builder: (context, state) {
        ...
        return Row(
          ...
          children: [
            minPlus(text: 'Wight', Num: CalcCubit.Wight, AddonPressed:(){cubit.addWight();}, MinonPressed:(){cubit.minWight();}),
            const SizedBox(
              width: 50,
            ),
            minPlus(text: 'Age', Num: CalcCubit.Age, AddonPressed:(){cubit.addAge();}, MinonPressed:(){cubit.minAge();}),
          ],
        );
      },
    );
